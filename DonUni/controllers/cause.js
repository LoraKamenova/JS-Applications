...
export default {
    get: {
        ...
        details(context) {
            ...
            models.cause.get(causeId).then((response) => {
                ...
                // Еквивалентно на долния ред e context.cause = cause и тогава в details трябва да се пише cause.cause, a не само cause
    ...
    put: {
        donate(context) {
            ...
            //     const cause = docModifier(response);
            //     cause.collectedFunds += Number(donatedAmount);
            //     cause.donors.push(localStorage.getItem('userId'));
            //
            //     return models.cause.donate(causeId, cause);
            // })
            //     .then((response) => {
